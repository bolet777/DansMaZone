export const categorySites = {
  ...
  'Bagages et Voyage': [
    {
      name: 'Bentley',
      url: 'https://www.shopbentley.com/fr/catalogsearch/result/?q=##QUERY##'
    },
    {
      name: 'La Cordonnerie',
      url: 'https://www.lacordonnerie.ca/recherche?q=##QUERY##'
    },
    {
      name: 'RUDSAK',
      url: 'https://www.rudsak.com/fr/search?q=##QUERY##'
    }
  ],
  'Beauté et Parfum': [
    {
  ...
  'Électroménager': [
    {
      name: 'Canadian Appliance Source',
      url: 'https://www.canadianappliance.ca/s.php?keywords=##QUERY##'
    },
    {
      name: 'Corbeil Électroménagers',
      url: 'https://www.corbeilelectro.com/catalogsearch/result/?q=##QUERY##'
    },
    {
      name: 'Germain Larivière',
      url: 'https://www.germainlariviere.com/catalogsearch/result/?q=##QUERY##'
    },
    {
      name: 'Brault & Martineau',
      url: 'https://www.braultetmartineau.com/search?q=##QUERY##'
    }
  ],
  'Électronique et Informatique': [
    {
      name: 'Canada Computers',
      url: 'https://www.canadacomputers.com/qc/recherche?s=##QUERY##'
    },
    {
      name: 'London Drugs',
      url: 'https://www.londondrugs.com/search?q=##QUERY##'
    },
    {
      name: 'Shopper+',
      url: 'https://shopperplus.com/fr/search?q=##QUERY##'
    },
    {
      name : 'Hamster',
      url : 'https://www.hamster.ca/recherche-produits?qs=##QUERY##'
    }
  ],
  'Épicerie et Alimentation': [
    {
      name: 'IGA',
      url: 'https://www.iga.net/fr/recherche?search=##QUERY##'
    },
    {
      name: 'Metro',
      url: 'https://www.metro.ca/search?filter=##QUERY##'
    },
    {
      name: 'Provigo',
      url: 'https://www.provigo.ca/search?search-bar=##QUERY##'
    }
  ],
  'Films et Séries TV': [
    {
      name: 'Archambault',
      url: 'https://www.archambault.ca/films-musique-et-spectacles?q=##QUERY##'
    },
    {
      name: 'Renaud-Bray',
      url: 'https://www.renaud-bray.com/Recherche.aspx?q=##QUERY##'
    },
    {
      name: 'Sunrise Records',
      url: 'https://www.sunriserecords.com/search?q=##QUERY##'
    }
  ],
  'Fournitures de Bureau': [
    ...
    {
      name: 'DeSerres',
      url: 'https://www.deserres.ca/fr/search?q=##QUERY##'
    }
  ],
  'Instruments de Musique': [
    {
      name: 'Archambault',
      url: 'https://www.archambault.ca/instruments-et-musique-en-feuille?q=##QUERY##'
    },
    {
      name: 'Steve\'s Music Store',
      url: 'https://www.stevesmusic.com/fr/catalogsearch/result/?q=##QUERY##'
    },
    {
      name: 'Italmelodie',
      url: 'https://www.italmelodie.com/fr/recherche?s=##QUERY##'
    }
  ],
  'Jardin': [
    {
      name: 'Jardin Jasmin',
      url: 'https://jardinjasmin.com/?s=##QUERY##'
    },
    {
      name: 'Pépinière Jasmin',
      url: 'https://pepinierejasmin.com/?s=##QUERY##'
    },
    {
      name: 'Jardins de Métis',
      url: 'https://jardinsdemetis.com/?s=##QUERY##'
    },
    {
      name: 'Jardins St-Léon',
      url: 'https://jardinsstleon.com/?s=##QUERY##'
    }
  ],
  'Jeux Vidéo et Consoles': [
    {
      name: 'GameStop',
      url: 'https://www.gamestop.ca/SearchResult/QuickSearch?q=##QUERY##'
    },
    {
      name: 'Microplay',
      url: 'https://www.microplay.com/recherche?controller=search&s=##QUERY##'
    }
  ],
  'Jouets et Jeux': [
    {
      name: 'Renaud-Bray',
      url: 'https://www.renaud-bray.com/Jeux.aspx?q=##QUERY##'
    },
    {
      name: 'Boutique Griffon',
      url: 'https://www.boutiquegriffon.ca/search?q=##QUERY##'
    }
  ],
  'Literie': [
    {
      name: 'Dormez-Vous',
      url: 'https://fr.dormezvous.com/search.php?search_query=##QUERY##'
    },
    {
      name: 'Linen Chest',
    ...
    {
      name: 'Rose Bonbon',
      url: 'https://rosebonbon.ca/search?type=product&q=##QUERY##'
    },
    {
      name: 'Brunelli',
  ...
  'Logiciels': [
    {
      name: 'Bureau en Gros',
      url: 'https://www.bureauengros.com/search?query=##QUERY##%20logiciel'
    }
  ],
  'Luminaire': [
    {
      name: 'Union Lighting',
      url: 'https://unionlighting.com/search?##QUERY##'
    },
    {
      name: 'Luminaire Authentik',
      url: 'https://luminaireauthentik.com/search?type=product&q=##QUERY##'
    },
    {
      name: 'Lumenco',
      url: 'https://lumenco.ca/search?type=product&q=##QUERY##'
    },
    {
      name: 'Luminaire Urbain',
      url: 'https://luminaireurbain.com/search?type=product&q=##QUERY##'
    }
  ],
  'Maison': [
    {
      name: 'Signé Local',
      url: 'https://www.signelocal.com/pages/search-results-page?q=##QUERY##'
    },
    {
      name: 'Bouclair',
      url: 'https://www.bouclair.com/fr/recherche?q=##QUERY##'
  ...
  'Mobilier': [
    {
      name: 'Maison Corbeil',
      url: 'https://maisoncorbeil.com/fr/catalogsearch/result/?q=##QUERY##'
    },
    {
      name: 'EQ3',
      url: 'https://www.eq3.com/ca/fr/search/##QUERY##'
    },
    {
      name: 'Nuspace',
      url: 'https://www.nuspace.ca/search?q=##QUERY##'
  ...
  'Mode et Vêtements': [
    ...
    {
      name: 'Sports Experts',
      url: 'https://www.sportsexperts.ca/fr-CA/search?q=##QUERY##'
    },
    {
      name: 'Reitmans',
      url: 'https://www.reitmans.com/fr/search?q=##QUERY##'
    }
  ],
  'Musique et CD': [
    {
      name: 'Archambault',
      url: 'https://www.archambault.ca/musique?q=##QUERY##'
    },
    {
      name: 'Renaud-Bray',
      url: 'https://www.renaud-bray.com/Musique_Produit.aspx?q=##QUERY##'
    },
    {
      name: 'Sunrise Records',
      url: 'https://www.sunriserecords.com/search?q=##QUERY##'
  ...
  'Salle de bain': [
    ...
    {
      name: 'Mondial',
      url: 'https://mondial.ca/?s=##QUERY##&post_type=product'
    },
    {
      name: 'Vanico Maronyx',
      url: 'https://vanico.com/fr/recherche?controller=search&s=##QUERY##'
    }
  ],
  ...
  'Sports et Plein air': [
    ...
    {
      name: 'La Cordée',
      url: 'https://www.lacordee.com/fr/recherche?q=##QUERY##'
    },
    {
      name: 'SAIL',
      url: 'https://www.sail.ca/fr/catalogsearch/result/?q=##QUERY##'
    }
  ],
  'Vêtements': [
    {
    ...
    {
      name: 'Frank and Oak',
      url: 'https://www.frankandoak.com/search?q=##QUERY##'
    },
    {
      name: 'M0851',
